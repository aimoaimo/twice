...
#declare AtomScale =0.5; // scaling of atom size relative to touching sphere radius  (close packing)  
...
#declare n_max=2;   // maximum number of +/- unit cells for making of crystal
...
#declare r_outer=1.2*a_fcc; // outer crystal sphere radius in lattice constants
