...
#declare AtomScale =0.35; // scaling of atom size relative to touching sphere radius  (close packing)  
...
#declare  EulerZ2 = -328.83;     
#declare  EulerX  = -47.95;   
#declare  EulerZ1 = -38.45;  
...
#declare n_max=25;   // maximum number of +/- unit cells for making of crystal
...
#declare r_outer=55.0*a_fcc; // outer crystal sphere radius in lattice constants
