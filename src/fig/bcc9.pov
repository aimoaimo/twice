...
#declare AtomScale =1.0; // scaling of atom size relative to touching sphere radius  (close packing)  
#declare Magnification =14;       // 1.0 = upper hemisphere in stereographic   
...
#declare n_max=10;   // maximum number of +/- unit cells for making of crystal
...
#declare r_outer=1.0*a_fcc; // outer crystal sphere radius in lattice constants
